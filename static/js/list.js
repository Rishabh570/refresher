$(document).ready(() => {
    ...
    $('.upvotes').click(function(e) {
        ...
        $.get('views/upvote/', mydata={ 'filter': filter }, function (votes) {
    ...
    $('.downvotes').click(function(e) {
        ...
        $.get('views/downvote/', mydata={ 'filter': filter }, function (votes) {
    ...
    $('.delete').click(function(e) {
        ...
        $.get('views/delete/', mydata = {'post_id': post_id}, function(callback) {
